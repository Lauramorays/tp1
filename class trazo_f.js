...
//funcion para dar color//
  darcolor(){
    ...
    let medOpacidad = lerp(this.minOpacidad, this.maxOpacidad, 0.04);

      //limitar el rango de brillo y opacidad(ajustar rango)//
      this.brillo = constrain(this.brillo, 100, 255);
      this.opacidad = constrain(this.opacidad, this.minOpacidad, this.maxOpacidad, this.medOpacidad);
  }
